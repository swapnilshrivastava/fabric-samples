...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	if function == "createUser" { //create a new marble
...
// ============================================================
// createUser - create a new user, store into chaincode state
// ============================================================
func (t *SimpleChaincode) createUser(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	var err error

	// 0       1                       2            3            4          5
	// 1, "swapnil.shrivastava", "xoriant123#", "swapnil", "Shrivastava", "User"
	if len(args) != 6 {
	...
	//userJSONasString := `{"docType":"User",  "name": "` + marbleName + `", "color": "` + color + `", "size": ` + strconv.Itoa(size) + `, "owner": "` + owner + `"}`
	...
	//  ==== Index the user to enable fname/lname-based range queries
